...
function getStats(price) {
    var url = "https://api.etherscan.io/api?module=proxy&action=eth_call&to=0xee609fe292128cad03b786dbb9bc2634ccdbe7fc&data=JN4BRW1CWIV2S6JCD4TNCGIQXJZSN54BZ4&tag=latest";
    return $.ajax(url, {
        cache: false,
        dataType: "json"
